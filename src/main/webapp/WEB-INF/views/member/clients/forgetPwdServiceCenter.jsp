<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
                        ...
                        <div>
                            <div class="flex" style="justify-content: space-between;">
                                ...
                                <div align="center">
                                    ...
                                    <button @click="connect" :disabled="connected"  class="btn btn-success">連接客服</button>&nbsp;&nbsp;
                                    <button @click="disconnect" :disabled="!connected"  class="btn btn-success">離開聊天室</button>&nbsp;&nbsp;

                                    <input type="text" v-model="messageInput" placeholder="請輸入訊息">&nbsp;&nbsp;
                                    <button @click="sendMessage" :disabled="!connected" class="btn btn-primary">傳送</button>
        ...
        <script type="module">
            ...
            var jsonData = sessionStorage.getItem("forgetPwdMid");
                ...
                methods: {
                    ...
                    disconnect() {
                        ...
                        setTimeout(() => {
                            ...
                            sessionStorage.removeItem("forgetPwdMid");
