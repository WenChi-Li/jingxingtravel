    ...
    <head>
        ...
        <script>
            ...
            <script> function viewOrder(orderId) {
                ...
                window.location.href = '/hotelOrder/viewuserOrder/' + orderId;
            }</script>
                ...
                <div class="row">
                    <div class="col">
                        <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4"
                            ...
                            <ol class="breadcrumb" style="margin: 10px 100px 10px 350px">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">訂單紀錄</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"><a
                        ...
                        <div >
                            ...
                            <div align="center" >
                                ...
                                <table border="1" class="table text-center">
                                    ...
                                    <c:forEach items="${ordersByMemberId}" var="order">
                                        <tr>
                                            <td><c:out value="${order.orderid}" /></td>
                                            <td><c:out value="${order.mid}" /></td>
