...
<body>
    <div class='container'>
    <div class='alert alert-success'><h2 align='center'>新增討論區資料</h2></div>
    ...
    <form method='POST' action="${insertUrl}">
            ...
            <div class='col-sm-1'>
                <c:choose>
                   ...
                   <c:otherwise>
                        ...
                        <input type='hidden' id='image2' name='forumImage' value='${image}'>
                   </c:otherwise>
                </c:choose>
            </div>    
        </div>
        <div class='row mb-3'>
            ...
            <div class='col-sm-3 d-grid'>
                <a class='btn btn-outline-primary' href="<c:url value='/forums' />" role='button'>放棄新增</a>
            </div>
        </div>
        </form>
        <hr>
