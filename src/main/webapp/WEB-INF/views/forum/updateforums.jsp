...
<body>
    <div class='container'>
    <div class='alert alert-success'><h2 align='center'>更新討論區資料</h2></div>
    ...
    <form method='POST' action="${insertUrl}">
        <div class='row mb-3'>
            ...
            <div class='col-sm-3'>
                <input type='text' class='form-control' name='forumIntroduction' 
                       value="${forums.forumIntroduction }"  />
            </div>
            ...
            <div class='col-sm-1'>
                <c:choose>
                   <c:when test='${empty forums.forumImage}' >
		                ...
		                <input type='hidden' id='image' name='forumImage' value="${forums.forumImage }">
                   </c:when>
                   <c:otherwise>
                        <img id='img' width='60' height='80' src='${forums.forumImage}' >
                        <input type='hidden' id='image2' name='forumImage' value="${forums.forumImage }">
                   </c:otherwise>
                </c:choose>
            </div>    
        </div>
        <div class='row mb-3'>
            ...
            <div class='col-sm-3 d-grid'>
                <a class='btn btn-outline-primary' href="<c:url value='/forums' />" role='button'>放棄更新</a>
            </div>
        </div>
        </form>
        <hr>
